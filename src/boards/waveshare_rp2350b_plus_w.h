...
/* (usbpods: rewritten from the newer-SDK `pico_board_cmake_set()` macro form
   to the SDK 2.1.1 magic-comment form — the bare macro is undefined there
   and broke assembly of every file including this header.) */
